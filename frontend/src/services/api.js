...
export const caseService = {
  ...
  acknowledge: (id, formData) => api.post(`/api/cases/${id}/acknowledge/`, formData),
  requestClosure: (id, formData) => api.post(`/api/cases/${id}/request-closure/`, formData),
  reviewClosure: (id, data = {}) => api.post(`/api/cases/${id}/review-closure/`, data),
  uploadClearanceCertificate: (id, formData) => api.post(`/api/cases/${id}/clearance-certificate/`, formData),
