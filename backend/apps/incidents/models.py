...
class Incident(models.Model):
    ...
    service_vehicle = models.CharField(max_length=500, blank=True)
    unit_involved = models.CharField(max_length=160, blank=True)
    originating_unit = models.CharField(max_length=160, blank=True)
    civilian = models.CharField(max_length=500, blank=True)
    service_member = models.CharField(max_length=500, blank=True)
